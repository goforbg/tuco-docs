...
<AccordionGroup>
  <Accordion title="400 — Missing required field: message">
    The `message` body field is required and was not provided.

    ```json
    { "error": "Missing required field: message" }
    ```

    **Fix:** Include a non-empty `message` string in your request body.
  </Accordion>
