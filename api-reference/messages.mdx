...
<Accordion title="Delivery tracking fields">
  ...
  <ResponseField name="externalMessageId" type="string">BlueBubbles / provider ID</ResponseField>
</Accordion>
...
| **Device gap** | Minimum time between sends from the same physical device | **Queued** or **rescheduled** |
| **Contact gap** | Minimum time between first messages to different contacts on the same line | Stay **queued** |
